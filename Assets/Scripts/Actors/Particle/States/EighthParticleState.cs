...
public class EighthParticleState : IParticleState 
{
	...
	public void Evol()
	{
		...
		if (evol == 0.5f && !inLightworld) {												// to dark world zero / from dark world
			...
			if (deltaDark > deltaLight) ToOtherWorld(true, 8, 0, false);						// if lose more light than dark = to light world dark zero
			else if (deltaDark <= deltaLight) ToOtherWorld(true, 8, 0, true);					// if lose more dark than light = to light world light zero
		}
			// in light world
		...
		if (evol == 1f && !inLightworld) {													// to dark world first / from dark world
			...
			if (deltaDark > deltaLight) ToOtherWorld(true, 8, 1, false);						// if lose more light than dark = to light world dark first
			else if (deltaDark <= deltaLight) ToOtherWorld(true, 8, 1, true);					// if lose more dark than light = to light world light first
		}
			// in light world
		...
		if (evol == 1.5f && !inLightworld) {												// to dark world second / from dark world
			...
			if (deltaDark > deltaLight) ToOtherWorld(true, 8, 2, false);						// if lose more light than dark = to light world dark second
			else if (deltaDark <= deltaLight) ToOtherWorld(true, 8, 2, true);					// if lose more dark than light = to light world light second
		}
			// in light world
		...
		if ((evol >= 2f && evol < 3f) && !inLightworld) {									// to dark world third / from dark world
			...
			if (deltaDark > deltaLight) ToOtherWorld(true, 8, 3, false);						// if lose more light than dark = to light world dark third
			else if (deltaDark <= deltaLight) ToOtherWorld(true, 8, 3, true);					// if lose more dark than light = to light world light third
		}
			// in light world
		...
		if ((evol >= 3f && evol < 5f) && !inLightworld) {									// to dark world fourth / from dark world
			...
			if (deltaDark > deltaLight) ToOtherWorld(true, 8, 4, false);						// if lose more light than dark = to light world dark fourth
			else if (deltaDark <= deltaLight) ToOtherWorld(true, 8, 4, true);					// if lose more dark than light = to light world light fourth
		}
			// in light world
		...
		if ((evol >= 5f && evol < 8f) && !inLightworld) {									// to dark world fifth / from dark world
			...
			if (deltaDark > deltaLight) ToOtherWorld(true, 8, 5, false);						// if lose more light than dark = to light world dark circle fifth
			else if (deltaDark <= deltaLight) ToOtherWorld(true, 8, 5, true);					// if lose more dark than light = to light world light circle fifth
		}
			// in light world
		...
		if ((evol >= 8f && evol < 13f) && !inLightworld) {									// to dark world sixth / from dark world
			...
			if (deltaDark > deltaLight) ToOtherWorld(true, 8, 6, false);						// if lose more light than dark = to light world dark circle sixth
			else if (deltaDark <= deltaLight) ToOtherWorld(true, 8, 6, true);					// if lose more dark than light = to light world light circle sixth
		}
			// in light world
		...
		if ((evol <= -21f && evol > -34f) && !inLightworld) {								// to light world eighth / from dark world
			if (deltaDark > deltaLight) ToOtherWorld(true, 8, 8, false);						// if lose more light than dark = to light world dark eighth
			else if (deltaDark <= deltaLight) ToOtherWorld(true, 8, 8, true);					// if lose more dark than light = to light world light eighth
		}
			// in light world
				// same state
		...
		if ((evol >= 34 && evol < 55) && !inLightworld) {									// to dark world ninth / from dark world
			...
			if (deltaDark > deltaLight) ToOtherWorld(true, 8, 9, false);						// if lose more light than dark = to light world dark ninth
			else if (deltaDark <= deltaLight) ToOtherWorld(true, 8, 9, true);					// if lose more dark than light = to light world light ninth
		}
			// in light world
