...
public class FourthParticleState : IParticleState 
{
	...
	public void Evol()
	{
		...
		if (evol == 0.5f && !lightworld) {													// devolve to dark world dark zero within dark world
			...
			if (deltaDark < deltaLight) ToOtherWorld(true, 4, 0, true);							// if lose more dark than light = to light zero
			else if (deltaDark > deltaLight) ToOtherWorld(true, 4, 0, true);					// if lose more light than dark = to light world dark zero
		}
