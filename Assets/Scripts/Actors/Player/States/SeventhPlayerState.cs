...
public class SeventhPlayerState : IParticleState 
{
	...
	public void UpdateState()															// updated each frame in PlayerStatePattern
	{
		// check evol
		if (checkEvol) {
			Debug.Log("player seventh: check evol");
	...
	public void Evol()
	{
        ...
        // eighth
			// in dark world
		if (((evol >= 21) && (evol < 34f)) || ((evol <= -21) && (evol > -34))) {							// to dark or light world eighth
		...
		// ninth
			// in dark world
		if (((evol >= 34) && (evol < 55f)) || ((evol <= -34f) && (evol > -55f))) {							// to dark or light world ninth
