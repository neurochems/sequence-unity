...
public class PlayerCoreManager : MonoBehaviour {
	...
	void Update() {
		...
		if (resetScale) {
			...
			if (resetScaleTimer >= 2.25f) {																				// when timer >= 4 sec
				...
				if (toState == 1 || toState == 2) ScaleTo (false, "hidden", "first");										// if to first/second, grow to first
				if (toState == 3 || toState == 4) ScaleTo (false, "hidden", "third");										// if to third/fourth, grow to third
				if (toState == 5 || toState == 6) ScaleTo (false, "hidden", "third");										// if to fifth/sixth, grow to third
	...
	///// seventh + eighth \\\\\
		...
		else if ((f == 7 || f == 8) && t == 5 && !fl && !tl && fs == 0 && ts == 0) ScaleTo (true, "seventh", "third");			// scale to first
		else if ((f == 7 || f == 8) && t == 6 && !fl && !tl && fs == 0 && ts == 0) ScaleTo (true, "seventh", "third");			// scale to first
		...
		// from dark triangle seventh/eighth
			// to dark triangle
		if ((f == 7 || f == 8) && t == 6 && !fl && !tl && fs == 1 && ts == 1) ScaleTo (true, "seventh", "third");				// scale to first
		else if ((f == 7 || f == 8) && t == 9 && !fl && !tl && fs == 1 && ts == 1) ScaleTo (false, "seventh", "ninth");			// scale to ninth
			// to light triangle
		if ((f == 7 || f == 8) && t == 5 && !fl && tl && fs == 1 && ts == 1) ScaleTo (true, "seventh", "third");				// scale to first
		else if ((f == 7 || f == 8) && t == 9 && !fl && tl && fs == 1 && ts == 1) ScaleTo (false, "seventh", "ninth");			// scale to ninth
		...
		// from dark square seventh/eighth
			// to dark square
		if ((f == 7 || f == 8) && t == 6 && !fl && !tl && fs == 2 && ts == 2) ScaleTo (true, "seventh", "third");				// scale to first
		else if ((f == 7 || f == 8) && t == 9 && !fl && !tl && fs == 2 && ts == 2) ScaleTo (false, "seventh", "ninth");			// scale to ninth
			// to light square
		if ((f == 7 || f == 8) && t == 5 && !fl && tl && fs == 2 && ts == 2) ScaleTo (true, "seventh", "third");				// scale to first
		else if ((f == 7 || f == 8) && t == 9 && !fl && tl && fs == 2 && ts == 2) ScaleTo (false, "seventh", "ninth");			// scale to ninth
	...
	///// ninth \\\\\
		...
		else if (f == 9 && t == 5 && !fl && !tl && fs == 0 && ts == 0) ScaleTo (true, "ninth", "third");						// scale to first
		else if (f == 9 && t == 6 && !fl && !tl && fs == 0 && ts == 0) ScaleTo (true, "ninth", "third");						// scale to first
		...
		if (f == 9 && t == 5 && fl && !tl && fs == 0 && ts == 0) ScaleTo (true, "ninth", "third");								// scale to first
		if (f == 9 && t == 6 && fl && !tl && fs == 0 && ts == 0) ScaleTo (true, "ninth", "third");								// scale to first
		...
		// from dark triangle ninth
			// to dark triangle
		if (f == 9 && t == 6 && !fl && !tl && fs == 1 && ts == 1) ScaleTo (true, "ninth", "third");								// scale to first
			...
			// to light triangle
		if (f == 9 && t == 5 && !fl && tl && fs == 1 && ts == 1) ScaleTo (true, "ninth", "third");								// scale to first
		else if (f == 9 && t == 7 && !fl && tl && fs == 1 && ts == 1) ScaleTo (true, "ninth", "seventh");						// scale to seventh
		else if (f == 9 && t == 8 && !fl && tl && fs == 1 && ts == 1) ScaleTo (true, "ninth", "seventh");						// scale to seventh
		else if (f == 9 && t == 10 && !fl && tl && fs == 1 && ts == 1) ScaleTo (false, "ninth", "tenth");						// scale to tenth
		...
		// from dark square ninth
			// to dark square
		if (f == 9 && t == 6 && !fl && !tl && fs == 2 && ts == 2) ScaleTo (true, "ninth", "third");								// scale to first
			...
			// to light square
		if (f == 9 && t == 5 && !fl && tl && fs == 2 && ts == 2) ScaleTo (true, "ninth", "third");								// scale to first
		else if (f == 9 && t == 7 && !fl && tl && fs == 2 && ts == 2) ScaleTo (true, "ninth", "seventh");						// scale to seventh
		else if (f == 9 && t == 8 && !fl && tl && fs == 2 && ts == 2) ScaleTo (true, "ninth", "seventh");						// scale to seventh
		else if (f == 9 && t == 10 && !fl && tl && fs == 2 && ts == 2) ScaleTo (false, "ninth", "tenth");						// scale to tenth
